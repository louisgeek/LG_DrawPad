 ...
 * quadTo
 */
public class MyVi1 extends View {
    ...
    public MyVi1(Context context) {
        super(context);
        init();
    }


    public MyVi1(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public MyVi1(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init();
    }

    public MyVi1(Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
