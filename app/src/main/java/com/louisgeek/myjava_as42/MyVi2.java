 ...
 */
public class MyVi2 extends View {
    private static final String TAG = "MyVi2";
    ...
    public MyVi2(Context context) {
        super(context);
        init();
    }


    public MyVi2(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public MyVi2(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init();
    }

    public MyVi2(Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
